...
#
# Created: Tue Jan 19 16:46:06 2016
...
class Ui_Form_abr(object):
    def setupUi(self, Form_abr):
        ...
        self.verticalLayout_Trace.addWidget(self.label_frequency)
        ...
        self.horizontalLayout_14.addWidget(self.comboBox_frequency)
        ...
        spacerItem4 = QtGui.QSpacerItem(20, 100, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Preferred)
        ...
        self.gridLayout_3.addWidget(self.pushButton_abr, 1, 1, 1, 1)
    ...
    def retranslateUi(self, Form_abr):
        ...
        self.pushButton_abr.setToolTip(_translate("Form_abr", "Creates an auditory brainstem response (ABR) graph based on your current test.", None))
        self.pushButton_abr.setText(_translate("Form_abr", "Plot ABR", None))
